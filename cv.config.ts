...
export const educationDetails = [
    ...
    {
        title: 'Intermediate',
        institution: 'Little Flower Children School',
        period: '[2019-2021]'
    },
    {
        title: 'HighSchool',
...
export const socialLinks = [
    {
        text: "abhinav7895",
        icon: FiGithub,
        href: "https://github.com/abhinav7895"
    },
    {
        text: "abhinavyadav.in",
        icon: FiGlobe,
    ...
    },
    {
        text: "abhinavay",
        icon: FiLinkedin,
        href: "https://www.linkedin.com/in/abhinavay/"
    },
    {
        text: "abhinavay",
        icon: RiTwitterXFill,
...
export const skillsDetails = [
    ...
    {
        category: 'Frontend',
        skills: ['React', 'Next.js', 'Tailwind', 'HTML', 'SCSS', 'REDUX', 'Vite']
    },
    {
        category: 'Backend',
        skills: ['Node.js', 'Docker', 'MongoDB', 'PostgreSQL', 'Prisma', 'GraphQL']
    },
    {
